...
st.set_page_config(page_title=" Fußball—Wettanalyse (Bundesliga)", layout="wide")
...
API_Links = {
    "1. Bundesliga": "https://api.openligadb.de/getmatchdata/bl1/2025/4",
    "2. Bundesliga": "https://api.openligadb.de/getmatchdata/bl2/2025/6"
